        	...
        	for(int i=1;i<=347;i++)
        	{
        		...
        		for(int j=0;j<link.size();j++)
        		{
        		  try
        		  {
        		   ...
        		   String data = m+"|"+vo.getName()+"|"+vo.getType()
	        		   +"|"+vo.getPhone()+"|"+vo.getAddress()+"|"+vo.getScore()+"|"+vo.getParking()
	        		   +"|"+vo.getPoster()+"|"+vo.getTime()+"|"+vo.getContent()+"|"+vo.getTheme()
	        		   +"|"+vo.getPrice();
        		   fw.write(data);
        		   fw.close();
        		   m++;
